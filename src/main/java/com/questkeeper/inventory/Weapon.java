...
public class Weapon extends Item {
    ...
    /**
     * Checks if this is a two-handed weapon.
     * Required by Inventory for equipment slot management.
     */
    ...
    /**
     * Gets the versatile damage dice string (when used two-handed).
     */
    ...
    /**
     * Calculates average damage (useful for comparisons).
     */
    ...
    /**
     * Sets both attack and damage bonus (for +X weapons).
     */
